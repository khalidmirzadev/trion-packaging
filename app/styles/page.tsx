...
import { STYLE_TAXONOMY } from "@/lib/data/catalog-taxonomy";
...
export const metadata: Metadata = {
  title: "Packaging Styles | Trion Packaging",
  description:
    "Browse 16 packaging styles: tuck boxes, mailer boxes, display boxes, pillow boxes, gable boxes, rigid trays, tubes, labels, paper bags, and more. Custom B2B packaging with CAD dielines within 24 hours.",
  openGraph: {
    title: "Packaging Styles | Trion Packaging",
    description:
      "Explore all packaging structural styles from Trion Packaging. Custom B2B manufacturing with ±0.5mm tolerances and 24-hour CAD dieline turnaround.",
    type: "website",
  },
};
      ...
      <section className="relative overflow-hidden pt-28 pb-20 border-b border-border/40">
        ...
        <div className="container text-center max-w-4xl relative z-10">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-10">
            From tuck-end retail cartons to luxury rigid slide-drawer boxes — browse every structural form we manufacture. Select a style to explore available configurations.
          </p>
          <Link
            href="/quote"
            className={cn(
        ...
        <div className="container max-w-7xl">
          <div className="mb-10">
            <span className="text-xs font-bold uppercase tracking-widest text-accent mb-2 block">
              {STYLE_TAXONOMY.length} Packaging Styles
            </span>
            <h2 className="text-3xl font-bold tracking-tight text-foreground">
              Browse by Structural Style
            </h2>
          </div>
            ...
            {STYLE_TAXONOMY.map((style) => (
              ...
              >
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed flex-1 line-clamp-2">
                  {style.subcategories.length} variants
                </p>
      ...
      <section className="py-16 border-t border-border/40">
        <div className="container text-center max-w-2xl">
          <h2 className="text-2xl font-bold tracking-tight text-foreground mb-4">
            Not sure which style fits your product?
          </h2>
          <p className="text-sm text-muted-foreground mb-8">
            Send your product dimensions and our structural engineers will recommend the optimal packaging form within 24 hours — at no charge.
          </p>
